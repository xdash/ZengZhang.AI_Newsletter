...
> 原链: https://blog.sshh.io/p/how-i-use-every-claude-code-feature  
> 来源: 未知来源 · 归档自 EP.32 · 抓取于 2026-08-06  
...
*If staying on the frontier of AI coding interests you or if your company doesn’t give you infinite Claude Code credits — [we are hiring!](https://abnormal.ai/careers)*
...
**/context**in one of my recent side projects. You can almost think of this like disk space that fills up as you work on a feature. After a few minutes or hours you’ll need to clear the messages (purple) to make space to continue.
...
We’ve used it to build custom “PR-from-anywhere” tooling. Users can trigger a PR from Slack, Jira, or even a CloudWatch alert, and the GHA will fix the bug or add the feature and return a fully tested PR[1](#footnote-1).
